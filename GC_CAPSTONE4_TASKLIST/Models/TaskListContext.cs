...
namespace GC_CAPSTONE4_TASKLIST.Models
{
    public partial class TaskListContext : DbContext
    {
        ...
        public virtual DbSet<EachTask> Task { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EachTask>(entity =>
            {
                ...
                entity.HasOne(d => d.ParentTask)
                    ...
                    .HasConstraintName("FK__Task__ParentTask__6C190EBB");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.Task)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Task__UserId__6D0D32F4");
            });
